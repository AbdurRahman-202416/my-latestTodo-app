...
const HomePage = () => {
    ...
    if (!categories) {
        return (
            <div>
                <div class=' shadow-lg rounded-md p-4 h-[50vh]  w-[90%] mx-auto'>
    ...
    return (
        ...
        <div className='mx-auto font-serif bg-gray-800 h-[400vh]  ' >
            <div className=' bg-black  mx-auto h-[200px] w-[100%] rounded-md'>
                ...
                <div className='flex justify-center gap-2 items-center mx-auto py-9 sm:py-[18px] px-[5%] w-[95%] sm:w-[80%]'>
                    ...
                    {isEdit ? <button onClick={saveEdit} className='flex gap-2 rounded-lg text-white bg-indigo-500 justify-center items-center h-[44px] sm:h-[54px] w-[120px]'>Save<img src="src\assets\img\plus.png" className='w-4 h-4 p1 mt-2 ' alt="" />
                    </button> : <button onClick={addCategories} className='flex gap-2  rounded-lg text-white bg-indigo-500 justify-center items-center h-[44px] sm:h-[54px] w-[120px]'>Create<img src="src\assets\img\plus.png" className='w-4 h-4  mt-1 ' alt="" /></button>
                    }
                </div>
            </div>
                        ...
                        return (
                            ...
                            <div key={Math.random()} className="h-auto group text-sm  shadow-sm shadow-gray-700  font-bold sm:text-3xl justify-between mx-8 my-16 flex">
                                <div className="justify-around items-center mx-0 sm:mx-6 gap-2 flex">
                                    ...
                                    <button onClick={() => editCategories(item.id, item)} className=' block sm:hidden group-hover:block'>
                                    ...
                                    <button onClick={() => handleOpenModal(item.id)} className='block sm:hidden  group-hover:block'>
                                        <img className=' w-5 sm:w-8 rounded-lg h-5 sm:h-8 ' src="src\assets\img\Layer 1.png" alt="" />
                                    </button>
                                </div>
